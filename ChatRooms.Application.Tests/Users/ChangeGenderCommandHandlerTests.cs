...
public sealed class ChangeGenderCommandHandlerTests
{
    private readonly Mock<IUserRepository> _userRepositoryMock;
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly Mock<IDateTimeProvider> _dateTimeProviderMock;
    private readonly ChangeGenderCommandHandler _handler;
    private readonly User _existingUser;
    private readonly Guid _userId;

    public ChangeGenderCommandHandlerTests()
    {
    ...
    {
        var command = new ChangeGenderCommand(_userId, Gender.Female);
    ...
    [Fact]
    public async Task Handle_SameGender_ShouldNotCallSave()
    {
        var command = new ChangeGenderCommand(_userId, Gender.Male);
